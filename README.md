# 🧠 LLM Wiki Starter Kit - Second Brain (v2.0)

> **最新版本**: v2.0 (第二大腦升級版 — 支援雙平台互動與極簡一鍵安裝)
>
...
2.進入該資料夾，並在終端機啟動
cd llm-wiki-starter-kit-second-brain
3.呼叫安裝精靈：執行以下指令：
/scaffold
4.安裝完後刪除剛剛Clone的安裝資料夾(llm-wiki-starter-kit-second-brain)
```
